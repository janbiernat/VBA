...
' 
    ...
    Dim W_K3 As Long 
    W_K1 = 0 
    W_K1 = ZnajdzPustaKomorke("Arkusz1", 1) 'WWywołanie funkcji ZnajdzPustaKomorke oraz przepisanie wyniku działania funkcji do zmiennej liczbowej "W_K1". 
    Cells(W_K1, 1).Value = W_K1 
    W_K2 = 0 
    W_K2 = ZnajdzPustaKomorke("Arkusz1", 2) 
    Cells(W_K2, 2).Value = W_K2 
    W_K3 = 0 
    W_K3 = ZnajdzPustaKomorke("Arkusz1", 3) 
