Sub WierszeNr(ArkuszNazwa As String, WierszNrOd As Long, KolumnaNr As Long) 
'WierszeNr - Numerowanie wierszy w wybranej kolumnie. 
'Copyright (c)by Jan T. Biernat 
' 
'Wywołanie procedury: 
'Call WierszeNr(nazwa_arkusza, nr_wiersza, nr_kolumny) 
' 
    Dim Licznik As Long 
    Licznik = 0 
