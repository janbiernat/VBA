Function DataJutroJest(Data_RMD As String) As String 
'DataJutroJest - Funkcja zwraca datę jutrzejszego dnia. 
'Copyright (c)by Jan T. Biernat 
' 
'Wywołanie funkcji: Cells(1, 2).Value = "'" + DataJutroJest(Cells(1, 1).Value) 
' 
    Dim R As Integer 
    Dim M As Integer 
    Dim D As Integer 
