...
'
    ...
    With Sheets("Tabliczka mnożenia - Losowanie") '5
    ...
    '   Po słowie With umieszcza się np. nazwę arkusza [tj. Sheets("Tabliczka mnożenia - Losowanie")]
    ...
    '   Sheets("Tabliczka mnożenia - Losowanie").Cells(1, 1).Value = ... .
